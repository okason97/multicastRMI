package rios.gaston.interfaces;/*
* rios.gaston.server.IfaceRemoteClass.java
...
public interface IfaceRemoteClass extends Remote{
    ...
    // For multicastRMI to work you must return object in the remote interface methods
    Object sendThisBack(byte[] data) throws RemoteException;
